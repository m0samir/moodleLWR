...
$string['timesplitting:upcoming3days_help'] = 'Este método de división de tiempo genera predicciones cada 3 días. Los cálculos indicativos se basarán en los próximos 3 días.';
$string['timesplitting:upcomingfortnight'] = 'Próxima quincena';
$string['timesplitting:upcomingfortnight_help'] = 'Este método de división de tiempo genera predicciones cada 2 semanas. Los cálculos indicativos se basarán en las próximas 2 semanas.';
$string['timesplitting:upcomingweek'] = 'Próxima semana';
$string['timesplitting:upcomingweek_help'] = 'Este método de división de tiempo genera predicciones cada semana. Los cálculos indicativos se basarán en la próxima semana.';
